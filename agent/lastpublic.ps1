...
if ($ripeOrg.Substring($ripeOrg.Length-1,1) -eq ",") { $ripeOrg = $ripeOrg.Substring(0,$ripeOrg.Length-1) }
if ($ripeNetName.Substring($ripeNetName.Length-1,1) -eq ",") { $ripeNetName = $ripeNetName.Substring(0,$ripeNetName.Length-1) }
